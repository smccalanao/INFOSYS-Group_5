...
<head>
    ...
    <title>SummitSync - Climber Companion</title>
                    ...
                    <nav class="main-nav">
                        ...
                        <div class="search-input">
                            <form id="search" action="#">
                                <input type="text" placeholder="Search climbs, trips..." id='searchText'
                            ...
                            <div class="col-lg-7">
                                <div class="header-text">
                                    ...
                                    <div class="main-button">
                                        <a href="explorer.html">Explore Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-button">
                                            <a href="explorer.html">Discover More Climbs</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
