...
<head>
  ...
  <title>SummitSync - Trip Explorer</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="top-downloaded">
                ...
                <ul>
                  <li>
                    <img src="assets/images/popular-01.jpg" alt="" class="templatemo-item">
                    <h4>Mount Apo</h4>
                    <h6>Moderate</h6>
                  </li>
                  <li>
                  ...
                  <li>
                    <img src="assets/images/popular-03.jpg" alt="" class="templatemo-item">
                    <h4>Mount Kanlaon</h4>
                    <h6>Hard</h6>
                  </li>
                </ul>
                <div class="text-button">
                  <a href="explorer.html">View All Trips</a>
                </div>
              </div>
            </div>
          </div>
